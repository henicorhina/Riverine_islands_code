...
cd /Volumes/Brumfield_Lab_Drive/data/by_species_take2/leucippus_chlorocercus/
...
# all instances of "leucippus_chlorocercus" with the name of your taxon
# paths to GATK, picard, and seqcap_pop scripts
# the maximum java ram permitted on your system (e.g. 'java -Xmx16g')

# bwa index

bwa index -a is /Volumes/Brumfield_Lab_Drive/data/2_itero/mafft-nexus-edge-trimmed-exploded-uncontaminated/leucippus_chlorocercus_63_LSU43036.fasta

# steps 4-8

for SAMPLE in leucippus_chlorocercus_58_LSU7264 leucippus_chlorocercus_62_LSU74801 leucippus_chlorocercus_63_LSU43036 leucippus_chlorocercus_64_LSU93457
do

	# step 4: map reads to contigs

	/Users/mharvey/src/bwa-0.7.17/bwa mem /Volumes/Brumfield_Lab_Drive/data/2_itero/mafft-nexus-edge-trimmed-exploded-uncontaminated/leucippus_chlorocercus_63_LSU43036.fasta \
...
SO=coordinate \
AS=true \
I=6_picard/mark_pcr_duplicates/leucippus_chlorocercus_58_LSU7264-aln_MD.bam \
I=6_picard/mark_pcr_duplicates/leucippus_chlorocercus_62_LSU74801-aln_MD.bam \
I=6_picard/mark_pcr_duplicates/leucippus_chlorocercus_63_LSU43036-aln_MD.bam \
I=6_picard/mark_pcr_duplicates/leucippus_chlorocercus_64_LSU93457-aln_MD.bam \
O=7_merge-bams/leucippus_chlorocercus.bam 


# step 10: index bams


samtools index 7_merge-bams/leucippus_chlorocercus.bam 


# steps 11 and 12: create and index dictionary

java -Xmx16g -jar ~/anaconda/pkgs/picard-1.106-0/jar/CreateSequenceDictionary.jar \
R=/Volumes/Brumfield_Lab_Drive/data/2_itero/mafft-nexus-edge-trimmed-exploded-uncontaminated/leucippus_chlorocercus_63_LSU43036.fasta \
O=/Volumes/Brumfield_Lab_Drive/data/2_itero/mafft-nexus-edge-trimmed-exploded-uncontaminated/leucippus_chlorocercus_63_LSU43036.dict

samtools faidx /Volumes/Brumfield_Lab_Drive/data/2_itero/mafft-nexus-edge-trimmed-exploded-uncontaminated/leucippus_chlorocercus_63_LSU43036.fasta
...
-R /Volumes/Brumfield_Lab_Drive/data/2_itero/mafft-nexus-edge-trimmed-exploded-uncontaminated/leucippus_chlorocercus_63_LSU43036.fasta \
-I 7_merge-bams/leucippus_chlorocercus.bam   \
--minReadsAtLocus 7 \
-o 8_GATK/leucippus_chlorocercus.intervals
...
-R /Volumes/Brumfield_Lab_Drive/data/2_itero/mafft-nexus-edge-trimmed-exploded-uncontaminated/leucippus_chlorocercus_63_LSU43036.fasta \
-I 7_merge-bams/leucippus_chlorocercus.bam  \
-targetIntervals 8_GATK/leucippus_chlorocercus.intervals \
-LOD 3.0 \
-o 8_GATK/leucippus_chlorocercus_RI.bam
...
-T UnifiedGenotyper \
-R /Volumes/Brumfield_Lab_Drive/data/2_itero/mafft-nexus-edge-trimmed-exploded-uncontaminated/leucippus_chlorocercus_63_LSU43036.fasta \
-I 8_GATK/leucippus_chlorocercus_RI.bam \
-gt_mode DISCOVERY \
-o 8_GATK/leucippus_chlorocercus_raw_SNPs.vcf \
-ploidy 2 \
-rf BadCigar
...
-V:variant,VCF 8_GATK/leucippus_chlorocercus_raw_SNPs.vcf \
-XA SnpEff \
-o 8_GATK/leucippus_chlorocercus_SNPs_annotated.vcf \
-rf BadCigar      
...
-gt_mode DISCOVERY \
-glm INDEL \
-o 8_GATK/leucippus_chlorocercus_SNPs_indels.vcf \
-rf BadCigar         
...
-T VariantFiltration \
-R /Volumes/Brumfield_Lab_Drive/data/2_itero/mafft-nexus-edge-trimmed-exploded-uncontaminated/leucippus_chlorocercus_63_LSU43036.fasta \
-V 8_GATK/leucippus_chlorocercus_raw_SNPs.vcf \
--mask 8_GATK/leucippus_chlorocercus_SNPs_indels.vcf \
--maskExtension 5 \
--maskName InDel \
...
--filterName "LowVQCBD" \
-o 8_GATK/leucippus_chlorocercus_SNPs_no_indels.vcf  \
-rf BadCigar


# step 19: Restrict to high-quality SNPs (bash)

cat 8_GATK/leucippus_chlorocercus_SNPs_no_indels.vcf | grep 'PASS\|^#' > 8_GATK/leucippus_chlorocercus_SNPs_pass-only.vcf 
...
-R /Volumes/Brumfield_Lab_Drive/data/2_itero/mafft-nexus-edge-trimmed-exploded-uncontaminated/leucippus_chlorocercus_63_LSU43036.fasta \
-I 8_GATK/leucippus_chlorocercus_RI.bam \
--variant 8_GATK/leucippus_chlorocercus_SNPs_pass-only.vcf \
-L 8_GATK/leucippus_chlorocercus_SNPs_pass-only.vcf \
-o 8_GATK/leucippus_chlorocercus_SNPs_phased.vcf \
...
do
	...
	-T SelectVariants \
	-R /Volumes/Brumfield_Lab_Drive/data/2_itero/mafft-nexus-edge-trimmed-exploded-uncontaminated/leucippus_chlorocercus_63_LSU43036.fasta \
	--variant 8_GATK/leucippus_chlorocercus_SNPs_phased.vcf \
	...
	/Volumes/Brumfield_Lab_Drive/data/2_itero/mafft-nexus-edge-trimmed-exploded-uncontaminated/leucippus_chlorocercus_63_LSU43036.fasta \
...
python /Users/mharvey/seqcap_pop-master/bin/gphocs_from_phy.py \
	13_processed-phylip/ \
	14_formatted_output/gphocs/leucippus_chlorocercus_GPHOCS.txt


# structure

python /Users/mharvey/seqcap_pop-master/bin/structure_from_vcf.py \
	8_GATK/leucippus_chlorocercus_SNPs_phased.vcf \
	14_formatted_output/structure/leucippus_chlorocercus_STRUCTURE.txt
