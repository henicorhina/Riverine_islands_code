...
cd /Volumes/Brumfield_Lab_Drive/data/by_species_take2/myrmotherula_klagesi/
...
# all instances of "myrmotherula_klagesi" with the name of your taxon
# paths to GATK, picard, and seqcap_pop scripts
# the maximum java ram permitted on your system (e.g. 'java -Xmx16g')

# bwa index

bwa index -a is /Volumes/Brumfield_Lab_Drive/data/2_itero/mafft-nexus-edge-trimmed-exploded-uncontaminated/myrmotherula_klagesi_100_INPA_A15925.fasta

# steps 4-8

for SAMPLE in myrmotherula_klagesi_95_LSU20250 myrmotherula_klagesi_96_LSU25562 myrmotherula_klagesi_97_LSU81357 myrmotherula_klagesi_98_LSU25511 myrmotherula_klagesi_99_INPA_A8276 myrmotherula_klagesi_100_INPA_A15925 myrmotherula_klagesi_101_INPA_A048
do

	# step 4: map reads to contigs

	/Users/mharvey/src/bwa-0.7.17/bwa mem /Volumes/Brumfield_Lab_Drive/data/2_itero/mafft-nexus-edge-trimmed-exploded-uncontaminated/myrmotherula_klagesi_100_INPA_A15925.fasta \
...
SO=coordinate \
AS=true \
I=6_picard/mark_pcr_duplicates/myrmotherula_klagesi_95_LSU20250-aln_MD.bam \
I=6_picard/mark_pcr_duplicates/myrmotherula_klagesi_96_LSU25562-aln_MD.bam \
I=6_picard/mark_pcr_duplicates/myrmotherula_klagesi_97_LSU81357-aln_MD.bam \
I=6_picard/mark_pcr_duplicates/myrmotherula_klagesi_98_LSU25511-aln_MD.bam \
I=6_picard/mark_pcr_duplicates/myrmotherula_klagesi_99_INPA_A8276-aln_MD.bam \
I=6_picard/mark_pcr_duplicates/myrmotherula_klagesi_100_INPA_A15925-aln_MD.bam \
I=6_picard/mark_pcr_duplicates/myrmotherula_klagesi_101_INPA_A048-aln_MD.bam \
O=7_merge-bams/myrmotherula_klagesi.bam 


# step 10: index bams


samtools index 7_merge-bams/myrmotherula_klagesi.bam 


# steps 11 and 12: create and index dictionary

java -Xmx16g -jar ~/anaconda/pkgs/picard-1.106-0/jar/CreateSequenceDictionary.jar \
R=/Volumes/Brumfield_Lab_Drive/data/2_itero/mafft-nexus-edge-trimmed-exploded-uncontaminated/myrmotherula_klagesi_100_INPA_A15925.fasta \
O=/Volumes/Brumfield_Lab_Drive/data/2_itero/mafft-nexus-edge-trimmed-exploded-uncontaminated/myrmotherula_klagesi_100_INPA_A15925.dict

samtools faidx /Volumes/Brumfield_Lab_Drive/data/2_itero/mafft-nexus-edge-trimmed-exploded-uncontaminated/myrmotherula_klagesi_100_INPA_A15925.fasta
...
-R /Volumes/Brumfield_Lab_Drive/data/2_itero/mafft-nexus-edge-trimmed-exploded-uncontaminated/myrmotherula_klagesi_100_INPA_A15925.fasta \
-I 7_merge-bams/myrmotherula_klagesi.bam   \
--minReadsAtLocus 7 \
-o 8_GATK/myrmotherula_klagesi.intervals
...
-R /Volumes/Brumfield_Lab_Drive/data/2_itero/mafft-nexus-edge-trimmed-exploded-uncontaminated/myrmotherula_klagesi_100_INPA_A15925.fasta \
-I 7_merge-bams/myrmotherula_klagesi.bam  \
-targetIntervals 8_GATK/myrmotherula_klagesi.intervals \
-LOD 3.0 \
-o 8_GATK/myrmotherula_klagesi_RI.bam
...
-T UnifiedGenotyper \
-R /Volumes/Brumfield_Lab_Drive/data/2_itero/mafft-nexus-edge-trimmed-exploded-uncontaminated/myrmotherula_klagesi_100_INPA_A15925.fasta \
-I 8_GATK/myrmotherula_klagesi_RI.bam \
-gt_mode DISCOVERY \
-o 8_GATK/myrmotherula_klagesi_raw_SNPs.vcf \
-ploidy 2 \
-rf BadCigar
...
-V:variant,VCF 8_GATK/myrmotherula_klagesi_raw_SNPs.vcf \
-XA SnpEff \
-o 8_GATK/myrmotherula_klagesi_SNPs_annotated.vcf \
-rf BadCigar      
...
-gt_mode DISCOVERY \
-glm INDEL \
-o 8_GATK/myrmotherula_klagesi_SNPs_indels.vcf \
-rf BadCigar         
...
-T VariantFiltration \
-R /Volumes/Brumfield_Lab_Drive/data/2_itero/mafft-nexus-edge-trimmed-exploded-uncontaminated/myrmotherula_klagesi_100_INPA_A15925.fasta \
-V 8_GATK/myrmotherula_klagesi_raw_SNPs.vcf \
--mask 8_GATK/myrmotherula_klagesi_SNPs_indels.vcf \
--maskExtension 5 \
--maskName InDel \
...
--filterName "LowVQCBD" \
-o 8_GATK/myrmotherula_klagesi_SNPs_no_indels.vcf  \
-rf BadCigar


# step 19: Restrict to high-quality SNPs (bash)

cat 8_GATK/myrmotherula_klagesi_SNPs_no_indels.vcf | grep 'PASS\|^#' > 8_GATK/myrmotherula_klagesi_SNPs_pass-only.vcf 
...
-R /Volumes/Brumfield_Lab_Drive/data/2_itero/mafft-nexus-edge-trimmed-exploded-uncontaminated/myrmotherula_klagesi_100_INPA_A15925.fasta \
-I 8_GATK/myrmotherula_klagesi_RI.bam \
--variant 8_GATK/myrmotherula_klagesi_SNPs_pass-only.vcf \
-L 8_GATK/myrmotherula_klagesi_SNPs_pass-only.vcf \
-o 8_GATK/myrmotherula_klagesi_SNPs_phased.vcf \
...
do
	...
	-T SelectVariants \
	-R /Volumes/Brumfield_Lab_Drive/data/2_itero/mafft-nexus-edge-trimmed-exploded-uncontaminated/myrmotherula_klagesi_100_INPA_A15925.fasta \
	--variant 8_GATK/myrmotherula_klagesi_SNPs_phased.vcf \
	...
	/Volumes/Brumfield_Lab_Drive/data/2_itero/mafft-nexus-edge-trimmed-exploded-uncontaminated/myrmotherula_klagesi_100_INPA_A15925.fasta \
...
python /Users/mharvey/seqcap_pop-master/bin/gphocs_from_phy.py \
	13_processed-phylip/ \
	14_formatted_output/gphocs/myrmotherula_klagesi_GPHOCS.txt


# structure

python /Users/mharvey/seqcap_pop-master/bin/structure_from_vcf.py \
	8_GATK/myrmotherula_klagesi_SNPs_phased.vcf \
	14_formatted_output/structure/myrmotherula_klagesi_STRUCTURE.txt
