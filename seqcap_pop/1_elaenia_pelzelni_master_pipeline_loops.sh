...
cd /Volumes/Brumfield_Lab_Drive/data/by_species_take2/elaenia_pelzelni/
...
# all instances of "elaenia_pelzelni" with the name of your taxon
# paths to GATK, picard, and seqcap_pop scripts
# the maximum java ram permitted on your system (e.g. 'java -Xmx16g')

# bwa index

bwa index -a is /Volumes/Brumfield_Lab_Drive/data/2_itero/mafft-nexus-edge-trimmed-exploded-uncontaminated/elaenia_pelzelni_35_LSU7249.fasta

# steps 4-8

for SAMPLE in elaenia_pelzelni_35_LSU7249 elaenia_pelzelni_36_Goeldi22693
do

	# step 4: map reads to contigs

	/Users/mharvey/src/bwa-0.7.17/bwa mem /Volumes/Brumfield_Lab_Drive/data/2_itero/mafft-nexus-edge-trimmed-exploded-uncontaminated/elaenia_pelzelni_35_LSU7249.fasta \
...
SO=coordinate \
AS=true \
I=6_picard/mark_pcr_duplicates/elaenia_pelzelni_35_LSU7249-aln_MD.bam \
I=6_picard/mark_pcr_duplicates/elaenia_pelzelni_36_Goeldi22693-aln_MD.bam \
O=7_merge-bams/elaenia_pelzelni.bam 


# step 10: index bams


samtools index 7_merge-bams/elaenia_pelzelni.bam 


# steps 11 and 12: create and index dictionary

java -Xmx16g -jar ~/anaconda/pkgs/picard-1.106-0/jar/CreateSequenceDictionary.jar \
R=/Volumes/Brumfield_Lab_Drive/data/2_itero/mafft-nexus-edge-trimmed-exploded-uncontaminated/elaenia_pelzelni_35_LSU7249.fasta \
O=/Volumes/Brumfield_Lab_Drive/data/2_itero/mafft-nexus-edge-trimmed-exploded-uncontaminated/elaenia_pelzelni_35_LSU7249.dict

samtools faidx /Volumes/Brumfield_Lab_Drive/data/2_itero/mafft-nexus-edge-trimmed-exploded-uncontaminated/elaenia_pelzelni_35_LSU7249.fasta
...
-R /Volumes/Brumfield_Lab_Drive/data/2_itero/mafft-nexus-edge-trimmed-exploded-uncontaminated/elaenia_pelzelni_35_LSU7249.fasta \
-I 7_merge-bams/elaenia_pelzelni.bam   \
--minReadsAtLocus 7 \
-o 8_GATK/elaenia_pelzelni.intervals
...
-R /Volumes/Brumfield_Lab_Drive/data/2_itero/mafft-nexus-edge-trimmed-exploded-uncontaminated/elaenia_pelzelni_35_LSU7249.fasta \
-I 7_merge-bams/elaenia_pelzelni.bam  \
-targetIntervals 8_GATK/elaenia_pelzelni.intervals \
-LOD 3.0 \
-o 8_GATK/elaenia_pelzelni_RI.bam
...
-T UnifiedGenotyper \
-R /Volumes/Brumfield_Lab_Drive/data/2_itero/mafft-nexus-edge-trimmed-exploded-uncontaminated/elaenia_pelzelni_35_LSU7249.fasta \
-I 8_GATK/elaenia_pelzelni_RI.bam \
-gt_mode DISCOVERY \
-o 8_GATK/elaenia_pelzelni_raw_SNPs.vcf \
-ploidy 2 \
-rf BadCigar
...
-V:variant,VCF 8_GATK/elaenia_pelzelni_raw_SNPs.vcf \
-XA SnpEff \
-o 8_GATK/elaenia_pelzelni_SNPs_annotated.vcf \
-rf BadCigar      
...
-gt_mode DISCOVERY \
-glm INDEL \
-o 8_GATK/elaenia_pelzelni_SNPs_indels.vcf \
-rf BadCigar         
...
-T VariantFiltration \
-R /Volumes/Brumfield_Lab_Drive/data/2_itero/mafft-nexus-edge-trimmed-exploded-uncontaminated/elaenia_pelzelni_35_LSU7249.fasta \
-V 8_GATK/elaenia_pelzelni_raw_SNPs.vcf \
--mask 8_GATK/elaenia_pelzelni_SNPs_indels.vcf \
--maskExtension 5 \
--maskName InDel \
...
--filterName "LowVQCBD" \
-o 8_GATK/elaenia_pelzelni_SNPs_no_indels.vcf  \
-rf BadCigar


# step 19: Restrict to high-quality SNPs (bash)

cat 8_GATK/elaenia_pelzelni_SNPs_no_indels.vcf | grep 'PASS\|^#' > 8_GATK/elaenia_pelzelni_SNPs_pass-only.vcf 
...
-R /Volumes/Brumfield_Lab_Drive/data/2_itero/mafft-nexus-edge-trimmed-exploded-uncontaminated/elaenia_pelzelni_35_LSU7249.fasta \
-I 8_GATK/elaenia_pelzelni_RI.bam \
--variant 8_GATK/elaenia_pelzelni_SNPs_pass-only.vcf \
-L 8_GATK/elaenia_pelzelni_SNPs_pass-only.vcf \
-o 8_GATK/elaenia_pelzelni_SNPs_phased.vcf \
...
do
	...
	-T SelectVariants \
	-R /Volumes/Brumfield_Lab_Drive/data/2_itero/mafft-nexus-edge-trimmed-exploded-uncontaminated/elaenia_pelzelni_35_LSU7249.fasta \
	--variant 8_GATK/elaenia_pelzelni_SNPs_phased.vcf \
	...
	/Volumes/Brumfield_Lab_Drive/data/2_itero/mafft-nexus-edge-trimmed-exploded-uncontaminated/elaenia_pelzelni_35_LSU7249.fasta \
...
python /Users/mharvey/seqcap_pop-master/bin/gphocs_from_phy.py \
	13_processed-phylip/ \
	14_formatted_output/gphocs/elaenia_pelzelni_GPHOCS.txt


# structure

python /Users/mharvey/seqcap_pop-master/bin/structure_from_vcf.py \
	8_GATK/elaenia_pelzelni_SNPs_phased.vcf \
	14_formatted_output/structure/elaenia_pelzelni_STRUCTURE.txt
